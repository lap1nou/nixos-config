WALLPAPERS_PATH="/etc/nixos/nixosModules/awesomewm/awesome/themes/1/wallpapers/"
CURRENT_WALLPAPER_PATH="/etc/nixos/nixosModules/awesomewm/awesome/themes/1/wallpaper.jpg"
...
# Reference: https://github.com/junegunn/fzf/pull/3567
