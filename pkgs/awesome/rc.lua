...
local function prompt_for_input(callback)
    awful.prompt.run {
        prompt = "Machine name: ",
...
mymainmenu = awful.menu({ items = { { "Awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "Nemo",function() awful.spawn.with_shell("nemo") end, beautiful.icon_nautilus},
                                    { "Peazip",function() awful.spawn.with_shell("peazip") end, beautiful.icon_peazip},
                                    { "Firefox",function() awful.spawn.with_shell("firefox") end, beautiful.icon_firefox },
                                    { "VSCode",function() awful.spawn.with_shell("code") end, beautiful.icon_vscode },
                                    { "ImHex",function() awful.spawn.with_shell("imhex") end, beautiful.icon_imhex },
                                    { "Open terminal", terminal, beautiful.icon_terminal },
                                    { "Exegol", function() 
                                                    prompt_for_input(function(machine_name) 
                                                             awful.prompt.run {
                                                                prompt = "IP: ",
                                                                textbox = awful.screen.focused().mypromptbox.widget,
                                                                exe_callback = function(ip)
                                                                    naughty.notify{ text = 'The input was: ' .. machine_name .. ' ' .. ip }
                                                                    awful.spawn.with_shell("wezterm start --new-tab -- htb-new " .. machine_name .. ' ' .. ip)
                                                                end
                                                            }
                                                    end)
                                                end, beautiful.icon_exegol },
                                    { "Lock screen",function() awful.spawn("physlock -s") end, beautiful.icon_lock },
                                    { "Shutdown",function() awful.spawn.with_shell("systemctl poweroff") end, beautiful.icon_power }
                                  }
                        })
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "  ", " ", " " }, s, awful.layout.layouts[1]) -- https://fontawesome.com/icons/circle?f=classic&s=solid
...
root.buttons(gears.table.join(
    ...
    awful.button({ }, 9, function (t) awful.screen.focused().mypromptbox:run() end)
))
...
client.connect_signal("request::titlebars", function(c)
    ...
    awful.titlebar(c, { size = 30 }) : setup {
        ...
        { -- Right
            ...
            -- Margin: https://www.reddit.com/r/awesomewm/comments/t2nmm2/setting_iconbutton_sizes_in_titlebar/
            top = 5,
            bottom = 5,
            left = 5,
            right = 5,
